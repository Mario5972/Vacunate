...
&& isset($_GET["aplicacion"]) && isset($_GET["fecha_aplicacion"])) {
  ...
  $insert="INSERT INTO tercera_aplicacion(id_vacuna, id_cartilla, aplicacion, fecha_aplicacion) VALUES ('{$id_vacuna}','{$id_cartilla}','{$aplicacion}','{$fecha_aplicacion}')";
  ...
  if($resultado_insert){
    ...
    if($registro=mysqli_fetch_assoc($resultado)){
      $json['tercera_aplicacion'][]=$registro;
    }
