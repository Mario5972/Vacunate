...
&& isset($_GET["aplicacion"]) && isset($_GET["fecha_aplicacion"])) {
  ...
  $insert="INSERT INTO refuerzo_aplicacion(id_vacuna, id_cartilla, aplicacion, fecha_aplicacion) VALUES ('{$id_vacuna}','{$id_cartilla}','{$aplicacion}','{$fecha_aplicacion}')";
  ...
  if($resultado_insert){
    ...
    if($registro=mysqli_fetch_assoc($resultado)){
      $json['refuerzo_aplicacion'][]=$registro;
    }
