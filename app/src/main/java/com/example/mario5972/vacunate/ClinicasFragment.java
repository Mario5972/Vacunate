 ...
 * {@link ClinicasFragment.OnFragmentInteractionListener} interface
...
public class ClinicasFragment extends Fragment implements OnMapReadyCallback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_clinicas, container, false);
    ...
    public void onMapReady(GoogleMap googleMap) {
        map = googleMap;
        LatLng point = new LatLng(19.505340, -99.146975);
        MarkerOptions options = new MarkerOptions();
        options.position(point).title("Casita");
